...
| Field | Value |
| --- | --- |
| Purpose | Shared rulebook for how YAi documentation is organized and maintained |
...
Use the root [README.md](../README.md) for product context and [docs/README.md](README.md) as the entry point into the shared docs tree.
