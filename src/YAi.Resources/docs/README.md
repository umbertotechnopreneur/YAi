**Document title:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> YAi.Resources Docs ✨  
**Prepared by:** Umberto Giacobbi  
**Organization:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> 🚀  
- **Intended use:** The local documentation index for bundled YAi assets, signed reference files, templates, and skills.  
...
Use this folder for resource-project-local notes about:

- `reference/templates/`
- `reference/skills/`
- signing targets and resource packaging
- asset ownership and maintenance boundaries
...
- `reference/`
- `YAi.Resources.Signing.targets`
- `YAi.Resources.csproj`

Operational signing steps stay shared. This folder is for local resource ownership and packaging notes.