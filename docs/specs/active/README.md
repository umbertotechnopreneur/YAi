**Document title:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> YAi Active Specs ✨  
**Prepared by:** Umberto Giacobbi  
**Organization:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> 🚀  
- **Intended use:** The shared index for active YAi specifications that currently guide implementation.  
