**Document title:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> YAi.Services.Core Docs ✨  
**Prepared by:** Umberto Giacobbi  
**Organization:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> 🚀  
- **Intended use:** The local documentation index for the current web API project and its future service-local implementation notes.  
...
# YAi.Services.Core Docs

## What belongs here

Use this folder for API-project-local notes about:

- endpoint layout
- controllers and services
- API-specific configuration
- current placeholder behavior and future growth
...
The current web app is still minimal. Local docs in this folder should describe current behavior first and only label future behavior as planned.