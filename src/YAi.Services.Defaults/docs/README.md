**Document title:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> YAi.Services.Defaults Docs ✨  
**Prepared by:** Umberto Giacobbi  
**Organization:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> 🚀  
- **Intended use:** The local documentation index for shared Aspire defaults, health endpoints, service discovery, and telemetry wiring.  
...
# YAi.Services.Defaults Docs

## What belongs here

Use this folder for local notes about the shared host defaults in `Extensions.cs`.
...
- `Extensions.cs`
- `YAi.Services.Defaults.csproj`

This folder should stay focused on the shared defaults project itself rather than describing the whole backend architecture.