**Document title:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> YAi.Client.CLI.Components Docs ✨  
**Prepared by:** Umberto Giacobbi  
**Organization:** <span style="color:#1E90FF">UmbertoGiacobbiDotBiz</span> 🚀  
- **Intended use:** The local documentation index for YAi CLI screen hosts, Razor screens, and shared CLI presentation state.  
